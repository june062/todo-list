...
/* harmony import */ var _schedule_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./schedule.js */ "./src/AppLogicModules/schedule.js");
...
/* harmony export */ });
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! date-fns */ "./node_modules/date-fns/formatDistanceToNowStrict.mjs");
...
let storeTasks = function(arrayOfProjects){
    for (let i = 0; i < arrayOfProjects.length; i++){
        ...
        for(let j = 0; j < arrayToLoop.length; j++){
            let daysPhrase = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__.formatDistanceToNowStrict)(arrayToLoop[j].dueDate, {unit: "day"});
...
class Task{
    ...
    constructor(taskName, description,dueDate,urgency, completed){
        ...
        this.dueDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__.format)(new Date(dueDate), "yyyy-MM-dd");
...
/* harmony import */ var _observer_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../observer.js */ "./src/observer.js");
/* harmony import */ var _tasksDOM_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./tasksDOM.js */ "./src/DOMLogicModules/tasksDOM.js");
...
let projectsDOM = (function (){
    ...
    function createProject(){
        ...
        newProject = new _AppLogicModules_projects_js__WEBPACK_IMPORTED_MODULE_0__.Project(projectTitleVal);
        _observer_js__WEBPACK_IMPORTED_MODULE_3__.subscriber.addProjectToArray(newProject);
    ...
    function displayAllProjects(){
        ...
        while(_domlogic_js__WEBPACK_IMPORTED_MODULE_2__.newProjectsContainer.firstChild){
            _domlogic_js__WEBPACK_IMPORTED_MODULE_2__.newProjectsContainer.removeChild(_domlogic_js__WEBPACK_IMPORTED_MODULE_2__.newProjectsContainer.firstChild);

        }
        for (const proj of _index_js__WEBPACK_IMPORTED_MODULE_1__.projectRemovalAndAddition.projects){
            let projectButton = document.createElement('button');
    ...
    function deleteProject(){
        _index_js__WEBPACK_IMPORTED_MODULE_1__.projectRemovalAndAddition.projects.splice(_index_js__WEBPACK_IMPORTED_MODULE_1__.projectRemovalAndAddition.projects.findIndex((element)=>{
            element.projectIdentifier === _tasksDOM_js__WEBPACK_IMPORTED_MODULE_4__.tasksDOM.returnSelectedProject().projectIdentifier;
        }), 1);
        displayAllProjects();
        while(_domlogic_js__WEBPACK_IMPORTED_MODULE_2__.mainContainer.lastChild !==_domlogic_js__WEBPACK_IMPORTED_MODULE_2__.taskContainer){
            _domlogic_js__WEBPACK_IMPORTED_MODULE_2__.mainContainer.removeChild(_domlogic_js__WEBPACK_IMPORTED_MODULE_2__.mainContainer.lastChild)
        }
...
/* harmony import */ var _index_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../index.js */ "./src/index.js");
/* harmony import */ var _observer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../observer.js */ "./src/observer.js");
...
let tasksDOM = (function () {
  ...
  function displayContentsOfProject(e) {
    ...
    if (!document.querySelector(".main-container > .add-task")) {
      ...
      _domlogic_js__WEBPACK_IMPORTED_MODULE_0__.mainContainer.append(addTask, deleteProject);
    }

    selectedProject = _index_js__WEBPACK_IMPORTED_MODULE_1__.projectRemovalAndAddition.projects.find(
  ...
  function createTasksDOM(element) {
    ...
    setAttributes(taskDueDateInput, {
      ...
      value: `${(0,date_fns__WEBPACK_IMPORTED_MODULE_3__.format)(new Date(element.dueDate), "yyyy-MM-dd")}`,
    });
    ...
    _domlogic_js__WEBPACK_IMPORTED_MODULE_0__.taskContainer.appendChild(taskForm);
    taskForm.append(
      taskNameDiv,
      taskDescriptionDiv,
      taskDueDateDiv,
...
/* harmony import */ var _DOMLogicModules_tasksDOM_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./DOMLogicModules/tasksDOM */ "./src/DOMLogicModules/tasksDOM.js");
...
newProjectsContainer.addEventListener("click", (e) => {
  _DOMLogicModules_tasksDOM_js__WEBPACK_IMPORTED_MODULE_1__.tasksDOM.displayContentsOfProject(e);
});
...
/* harmony import */ var _DOMLogicModules_projectsDOM_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./DOMLogicModules/projectsDOM.js */ "./src/DOMLogicModules/projectsDOM.js");
...
/* harmony import */ var _AppLogicModules_schedule_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./AppLogicModules/schedule.js */ "./src/AppLogicModules/schedule.js");
/* harmony import */ var _storage_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./storage.js */ "./src/storage.js");
/* harmony import */ var _AppLogicModules_projects_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./AppLogicModules/projects.js */ "./src/AppLogicModules/projects.js");
/* harmony import */ var _AppLogicModules_tasks_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./AppLogicModules/tasks.js */ "./src/AppLogicModules/tasks.js");
...
let Subscriber = function(){
    ...
    let schedule = function(){
        _AppLogicModules_schedule_js__WEBPACK_IMPORTED_MODULE_1__.storeTasksInTimeObject.storeTasks(_index_js__WEBPACK_IMPORTED_MODULE_0__.projectRemovalAndAddition.projects)
    }
    let storage = function(){
        _storage_js__WEBPACK_IMPORTED_MODULE_2__.storageManager.sendToLocalStorage(_index_js__WEBPACK_IMPORTED_MODULE_0__.projectRemovalAndAddition.projects)
    }
    let addProjectToArray = function(projectName){
        _index_js__WEBPACK_IMPORTED_MODULE_0__.projectRemovalAndAddition.projects.push(projectName);
        storage();
    }
    
    let removeProjectFromArray =  function(){
        findProject();
        _index_js__WEBPACK_IMPORTED_MODULE_0__.projectRemovalAndAddition.projects.splice(projectIndex,1);
        storage();
      
    }
    let findProject = function(projectIdentifier, projectName){
        let projectIndex = _index_js__WEBPACK_IMPORTED_MODULE_0__.projectRemovalAndAddition.projects.findIndex(element=>element.projectIdentifier === projectIdentifier && element.projectName === projectName);
        return projectIndex;
    ...
    let editTask = function(firstVal,secondVal, target){
        let projIndex = _index_js__WEBPACK_IMPORTED_MODULE_0__.projectRemovalAndAddition.projects.findIndex((element)=>
            firstVal === element.projectIdentifier)
            
        let taskIndex = _index_js__WEBPACK_IMPORTED_MODULE_0__.projectRemovalAndAddition.projects[projIndex].arrayOfTasks.findIndex((element)=>
            secondVal === element.taskIdentifier)
        
    
        let selectedTask = _index_js__WEBPACK_IMPORTED_MODULE_0__.projectRemovalAndAddition.projects[projIndex].arrayOfTasks[taskIndex];
    ...
    let createDefaultProject = function(){
            let defaultProject = new _AppLogicModules_projects_js__WEBPACK_IMPORTED_MODULE_3__.Project("Default Project");
...
subscriber.addObserver(_storage_js__WEBPACK_IMPORTED_MODULE_2__.storageManager);
subscriber.addObserver(_AppLogicModules_schedule_js__WEBPACK_IMPORTED_MODULE_1__.storeTasksInTimeObject)
...
/* harmony export */ });
/* harmony import */ var _AppLogicModules_projects_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./AppLogicModules/projects.js */ "./src/AppLogicModules/projects.js");
/* harmony import */ var _AppLogicModules_tasks_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./AppLogicModules/tasks.js */ "./src/AppLogicModules/tasks.js");
...
let storageManager = (function(){
    ...
    function sendToLocalStorage(arrayOfProjects){
        ...
        localStorage.setItem("todaysSchedule", JSON.stringify(_AppLogicModules_schedule_js__WEBPACK_IMPORTED_MODULE_2__.storeTasksInTimeObject.todaysSchedule))
        localStorage.setItem("thisWeeksSchedule", JSON.stringify(_AppLogicModules_schedule_js__WEBPACK_IMPORTED_MODULE_2__.storeTasksInTimeObject.thisWeeksSchedule))
        localStorage.setItem("thisMonthsSchedule", JSON.stringify(_AppLogicModules_schedule_js__WEBPACK_IMPORTED_MODULE_2__.storeTasksInTimeObject.thisMonthsSchedule))
        localStorage.setItem("projectIdentifier", _AppLogicModules_projects_js__WEBPACK_IMPORTED_MODULE_0__.Project.projectIdentifier)
        localStorage.setItem("taskIdentifier", _AppLogicModules_tasks_js__WEBPACK_IMPORTED_MODULE_1__.Task.taskIdentifier)
        
    };

    function retrieveFromLocalStorage(){
        _index_js__WEBPACK_IMPORTED_MODULE_3__.projectRemovalAndAddition.setProjects = JSON.parse(localStorage.getItem("arrayOfProjects"));
        for(let proj of _index_js__WEBPACK_IMPORTED_MODULE_3__.projectRemovalAndAddition.projects){
          Object.setPrototypeOf(proj, _AppLogicModules_projects_js__WEBPACK_IMPORTED_MODULE_0__.Project.prototype)

        }
        Object.assign(_AppLogicModules_schedule_js__WEBPACK_IMPORTED_MODULE_2__.storeTasksInTimeObject.todaysSchedule, JSON.parse(localStorage.getItem("todaysSchedule")));
        Object.assign(_AppLogicModules_schedule_js__WEBPACK_IMPORTED_MODULE_2__.storeTasksInTimeObject.thisWeeksSchedule,JSON.parse(localStorage.getItem("thisWeeksSchedule")));
        Object.assign(_AppLogicModules_schedule_js__WEBPACK_IMPORTED_MODULE_2__.storeTasksInTimeObject.thisMonthsSchedule,JSON.parse(localStorage.getItem("thisMonthsSchedule"))); 
        _AppLogicModules_projects_js__WEBPACK_IMPORTED_MODULE_0__.Project.projectIdentifier = localStorage.getItem("projectIdentifier");
        _AppLogicModules_tasks_js__WEBPACK_IMPORTED_MODULE_1__.Task.taskIdentifier = localStorage.getItem("taskIdentifier");
    }
